...
<!-- /Yandex.Metrika counter -->
    ...
    <meta property="og:title" content="Лучшая мебель СНГ - {$name}">
    ...
    <title>Лучшая мебель СНГ -{$name}</title>
	...
	<script defer src="/Template/colorpicker/js/evol-colorpicker.min.js"type="text/javascript"charset="text/javascript"></script>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone" style="margin-right:5px;"></i>{$info.telephone}</a></li>
								<li><a href="#"><i class="fa fa-envelope" style="margin-right:5px;"></i>{$info.email}</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								<li><a href="{$info.vk}"><i class="fa fa-vk" target="_blank" title="ВКонтакте"></i></a></li>
								<li><a href="{$info.instagram}"><i class="fa fa-instagram" target="_blank" title="Инстаграм"></i></a></li>
							</ul>
						</div>
					</div>
				</div>

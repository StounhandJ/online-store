...
--
-- Хост: localhost
-- Время создания: Ноя 30 2020 г., 19:22
...
(25, 'Не знаю', '34 500 р.', 'Все так говорят, а ты купи кровать', 'Кровати', 0, '9a390fe69c28abe337050175a601f2b7'),
...
(29, 'Тест 78', '67 000 р.', 'Много текста', 'Шкафы', 1, 'd72d82231621bad910d37557b290ac25');
...
(7, 'descriptionProduct', ' на заказа по размеру и выбранному цвету. В Москве изготовление под заказ мебели с доставкой'),
...
(10, 'descriptionMain', 'Заказ мебели на заказ на ваш выбор.');

...
--
-- Хост: localhost
-- Время создания: Ноя 20 2020 г., 21:37
...
(21, 'Люкс кровать', '250 000 р.', 'Опять же много текста. Это все не я!!!', 'Кровати', 0, 'd85b90873d586f7e45e175712a4ae9a4'),
(23, 'Тестовы', '100 р.', 'Много тектсат оапоааащжэ', 'Стулья', 0, 'fdf9613d5129d62e22e38ff9b7227d51'),
(24, 'Тесте 2', '200 р.', 'Больше такого не будет', 'Стулья', 0, '75cb3df29f837b362d1bffdc806c6a72'),
(25, 'Не знаю', '34 500 р.', 'Все так говорят, а ты купи кровать', 'Кровати', 0, 'fccdc83794edc0648b933045b374d812'),
(26, 'Жопелю де ля сортир для Жени', '2500 р.', 'Не бери!!!', 'Кровати', 0, 'a9dde99d7c71bde13d64654391bb3860'),
...
(1, 'telephone', '+7 909 697 95 79'),
(2, 'email', 'test__email@rushop.ru'),
